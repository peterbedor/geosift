...
Wee.fn.make("api",{get:function(a){this.$private.send(a)},post:function(a){this.$private.send(Wee.$extend(!0,{method:"post"},a))},put:function(a){this.$private.send(Wee.$extend(!0,{method:"put"},a))},delete:function(a){this.$private.send(Wee.$extend(!0,{method:"delete"},a))}},{send:function(a){Wee.fetch.request($.extend(!0,{headers:{"X-CSRF-TOKEN":Wee.$get("csrfToken")}},a))}}),Wee.fn.make("common",{init:function(){this.$private.initHistory()}},{initHistory:function(){$("a").on("mousedown",function(){var a=$(this);if("none"==a.css("outline-style")){var b="-no-outline";a.addClass(b).on("blur",function(){a.removeClass(b)},{once:!0})}},{delegate:$._body})}}),Wee.fn.make("entry",{init:function(){this.$private.bindEvents()}},{bindEvents:function(){$("ref:fieldForm").submit(function(a,b){var c=$(b);Wee.api.post({url:c.attr("action"),data:c.serialize(),success:function(a){console.log(a)}}),a.preventDefault()})}}),Wee.fn.make("extension",{_construct:function(){var a="-is-disabled",b="-is-active";$.chain({disable:function(){return this.addClass(a),this},enable:function(){return this.removeClass(a),this},toggleEnable:function(){return this.toggleClass(a),this},isDisabled:function(){return this.hasClass(a)},isEnabled:function(){return!this.hasClass(a)},activate:function(){return this.addClass(b),this},deactivate:function(){return this.removeClass(b),this},toggleActive:function(){return this.toggleClass(b),this},isActive:function(){return this.hasClass(b)},isInactive:function(){return!this.hasClass(b)},click:function(a,b){return b=b||{},this.on("click",a,b)},change:function(a,b){return b=b||{},this.on("change",a,b)},submit:function(a,b){return b=b||{},this.on("submit",a,b)}})}}),Wee.fn.make("login",{init:function(){Wee.infieldLabels.init()}},{method:function(){}}),Wee.fn.make("navigation",{init:function(){this.$private.init()}},{_construct:function(){this.$navigation=$("ref:navigation"),this.$navigationToggle=$("ref:menuToggle")},init:function(){this.$navigationToggle.click(function(){this.toggleMenu()}.bind(this))},toggleMenu:function(){Wee.overlay.toggle(),this.$navigation.toggleEnable()}}),Wee.fn.make("overlay",{show:function(){this.$private.show()},hide:function(){this.$private.hide()},toggle:function(){this.$private.toggle()}},{_construct:function(){this.$overlay=$("ref:overlay")},show:function(){this.$overlay.show(),this.timeout(function(){this.$overlay.activate()}.bind(this))},hide:function(){this.$overlay.deactivate(),this.timeout(function(){this.$overlay.hide()}.bind(this),200)},toggle:function(){this.$overlay.isActive()?this.hide():this.show()},timeout:function(a,b){b=b||1,$._win.setTimeout(function(){a()},b)}}),Wee.fn.make("register",{init:function(){Wee.infieldLabels.init()}},{method:function(){}}),Wee.routes.map({$any:["common","navigation"],login:"login",register:"register",collections:{$num:{entries:{new:"entry"}}}}),Wee.ready("routes:run"),Wee.fn.make("infieldLabels",{_construct:function(){this.namespace="infieldLabels"},init:function(a){var b=$.extend({selector:"ref:infieldInput",focusClass:"-is-focused",activeClass:"-is-active"},a),c=$(b.selector),d=b.focusClass,e=b.activeClass;c.each(function(a){var b=$(a);b.val()&&b.parent().addClass(e)}),c.on("focus."+this.namespace,function(a,b){$(b).parent().addClass(e+" "+d)}),c.on("blur."+this.namespace,function(a,b){var c=$(b);c.parent().removeClass(d),c.val()||c.parent().removeClass(e)})},destroy:function(){$.events.off(!1,"."+this.namespace)}});
